...
import $packageName.databinding.OnbFragmentContainerBinding
...
class ${featureName.capitalize()}FeatureFragment : FeatureFragment(), NavigationHelper {

    companion object {
        const val ACTION_SHOW_FEATURE_MAIN_SCREEN = "ACTION_SHOW_FEATURE_MAIN_SCREEN"

        fun newInstance(bundle: Bundle? = null) = OnboardingFeatureFragment().apply {
            arguments = bundle
        }
    }
    ...
    private val viewModel: ${featureName.capitalize()}ViewModel by viewModels()
    private val binding by viewBinding(OnbFragmentContainerBinding::bind)

    override fun onAttach(context: Context) {
        ${featureName.capitalize()}Feature.getFeatureComponent()?.inject(this)
    ...
    override fun onDestroy() {
        ${featureName.capitalize()}Feature.releaseFeatureComponent()
        super.onDestroy()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.onb_fragment_container, container, false)
    }
